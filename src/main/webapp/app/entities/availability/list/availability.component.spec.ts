...
describe('Availability Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'availability', component: AvailabilityComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to availabilityService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAvailabilityIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAvailabilityIdentifier).toHaveBeenCalledWith(entity);
