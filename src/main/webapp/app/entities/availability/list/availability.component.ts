...
import { EntityArrayResponseType, AvailabilityService } from '../service/availability.service';
...
export class AvailabilityComponent implements OnInit {
  ...
  trackId = (_index: number, item: IAvailability): number => this.availabilityService.getAvailabilityIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.availabilities = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IAvailability[] | null): IAvailability[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.availabilityService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
