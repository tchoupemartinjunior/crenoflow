...
describe('Booking Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Course query and add missing value', () => {
      ...
      const course: ICourse = { id: 22402 };
      booking.course = course;

      const courseCollection: ICourse[] = [{ id: 2485 }];
    ...
    it('Should call Person query and add missing value', () => {
      const booking: IBooking = { id: 456 };
      const parent: IPerson = { id: 19750 };
      booking.parent = parent;
      const student: IPerson = { id: 7513 };
      booking.student = student;

      const personCollection: IPerson[] = [{ id: 21628 }];
      jest.spyOn(personService, 'query').mockReturnValue(of(new HttpResponse({ body: personCollection })));
      const additionalPeople = [parent, student];
    ...
    it('Should update editForm', () => {
      const booking: IBooking = { id: 456 };
      const course: ICourse = { id: 9512 };
      booking.course = course;
      const parent: IPerson = { id: 1006 };
      booking.parent = parent;
      const student: IPerson = { id: 1964 };
      booking.student = student;
      ...
      expect(comp.peopleSharedCollection).toContain(parent);
      expect(comp.peopleSharedCollection).toContain(student);
