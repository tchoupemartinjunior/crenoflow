...
import { EducationLevelDeleteDialogComponent } from './education-level-delete-dialog.component';
...
describe('EducationLevel Management Delete Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, EducationLevelDeleteDialogComponent],
