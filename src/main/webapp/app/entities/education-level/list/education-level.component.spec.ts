...
describe('EducationLevel Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'education-level', component: EducationLevelComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.educationLevels?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to educationLevelService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEducationLevelIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEducationLevelIdentifier).toHaveBeenCalledWith(entity);
