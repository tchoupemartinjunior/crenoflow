...
describe('Profession Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'profession', component: ProfessionComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to professionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProfessionIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProfessionIdentifier).toHaveBeenCalledWith(entity);
