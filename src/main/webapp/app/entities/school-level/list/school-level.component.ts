...
import { EntityArrayResponseType, SchoolLevelService } from '../service/school-level.service';
...
export class SchoolLevelComponent implements OnInit {
  ...
  trackId = (_index: number, item: ISchoolLevel): number => this.schoolLevelService.getSchoolLevelIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.schoolLevels = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ISchoolLevel[] | null): ISchoolLevel[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.schoolLevelService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
