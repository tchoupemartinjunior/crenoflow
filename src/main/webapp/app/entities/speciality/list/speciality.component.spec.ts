...
describe('Speciality Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'speciality', component: SpecialityComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.specialities?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to specialityService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSpecialityIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSpecialityIdentifier).toHaveBeenCalledWith(entity);
