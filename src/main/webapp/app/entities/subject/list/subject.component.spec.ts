...
describe('Subject Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'subject', component: SubjectComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to subjectService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSubjectIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSubjectIdentifier).toHaveBeenCalledWith(entity);
