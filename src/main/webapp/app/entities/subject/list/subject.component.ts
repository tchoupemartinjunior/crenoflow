...
import { EntityArrayResponseType, SubjectService } from '../service/subject.service';
...
export class SubjectComponent implements OnInit {
  ...
  trackId = (_index: number, item: ISubject): number => this.subjectService.getSubjectIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: ISubject[] | null): ISubject[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.subjectService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
