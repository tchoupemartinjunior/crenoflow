...
import { EntityArrayResponseType, TeacherService } from '../service/teacher.service';
...
export class TeacherComponent implements OnInit {
  ...
  trackId = (_index: number, item: ITeacher): number => this.teacherService.getTeacherIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.teachers = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ITeacher[] | null): ITeacher[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.teacherService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
